...
class Purchase_Requisition (models.Model):
    ...
    type_consultation= fields.Selection([('tous', "Tous les fournisseurs"),('homologue', "Fournisseurs homologués")], 'Type',default='homologue')
    organization_unit_id= fields.Many2one('operating.unit', 'Unité d\'organisation', default=_get_operating_unit_id,readonly=True)
